        ...
        <div className="row">
          <div className="col-lg-4 col-md-4 col-sm-6">
            <div className="tm-home-box-1">
              <ul
                className="nav nav-tabs tm-white-bg"
                role="tablist"
                id="hotelCarTabs"
              >
              ...
              <div className="tab-content">
                <div
                  role="tabpanel"
                  className="tab-pane fade in active tm-white-bg"
                  id="hotel"
                >
                ...
                <div
                  role="tabpanel"
                  className="tab-pane fade tm-white-bg"
                  id="car"
                >
                  <div className="tm-search-box effect2">
                    <form
                    ...
                    >
                      <div className="tm-form-inner">
                        ...
                        <div className="form-group">
                          <div
                            className="input-group date-time"
                            id="datetimepicker3"
                          >
                            <input
                              type="text"
          ...
          <div className="row">
            <div className="tm-section-header section-margin-top">
              ...
              <div className="col-lg-4 col-md-6 col-sm-6">
                <h2 className="tm-section-title">Popular Packages</h2>
              </div>
              <div className="col-lg-4 col-md-3 col-sm-3">
                <hr />
              </div>
